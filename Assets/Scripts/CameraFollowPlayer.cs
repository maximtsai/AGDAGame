...
public class CameraFollowPlayer : MonoBehaviour {
	...
	void FixedUpdate() {
        ...
        if (hasPlayerTwo)
        {
            ...
            wantedPos = (player1.transform.TransformPoint(0, distance, height)
                + (player1Vel + player2Vel) * velInfluence
                + (player1Acc + player2Acc) * accInfluence
                + player2.transform.TransformPoint(0, distance, height)) / 2;
            player2PrevPos = player2.transform.position;
        ...
        } else
        {
            ...
            wantedPos = player1.transform.TransformPoint(randCamOffsetX, distance + movementBasedDistance + randCamOffsetY, height);
